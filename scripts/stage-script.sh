...
sed -i "s#BUILD_NUMBER#$IMAGE_TAG#g" ./scripts/stage-task-definition.json
sed -i "s#REPOSITORY_URI#$REPOSITORY_URI#g" ./scripts/stage-task-definition.json
sed -i "s#ROLE_ARN#$ROLE_ARN#g" ./scripts/stage-task-definition.json
sed -i "s#FAMILY#$FAMILY#g" ./scripts/stage-task-definition.json
sed -i "s#NAME#$NAME#g" ./scripts/stage-task-definition.json
